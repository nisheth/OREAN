...
This is an automated message from OREAN. A password reset request was made for the account associated with this email. 
...
""" % (myuser.first_name, myurl)
      send_new_email(request, myuser.email, 'OREAN Password Reset', message)
